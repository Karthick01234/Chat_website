...
$product_array = $db_handle->runQuery("SELECT * FROM passbook WHERE email ='".$id."'");
	...
	foreach($product_array as $key=>$value){
		if(!empty($product_array[$key]["photo"])) {
			if(!empty($product_array[$key]["skill"])) {
...
?> 
<?php
$product_array = $db_handle->runQuery("SELECT * FROM project WHERE email !='".$id."' AND email !='company' ORDER BY id DESC");
	if (!empty($product_array)) { 
	foreach($product_array as $key=>$value){
...
<form action="bite.php" method="post">
...
<?php
				...
				?>
<div align="middle">
<div style="background:linear-gradient(to bottom, pink 30%, orange 103%);border:1px solid grey;width:600px"> <font color="grey" size="4"> <br> <br>Sorry !&nbsp;&nbsp;you won't update your skills in vintax-vc <br> <br> / *&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Inorder to work first update your skills &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; * / <br> <br><a href="updateskill.php"> <button style="background:linear-gradient(to bottom, pink 30%, orange 103%);border:1px solid grey;padding:10px 10px"> <font color="grey" size="4">Update Skill</font> </button> </a></font> </div> </div>
<?php
			}
		}
	}
