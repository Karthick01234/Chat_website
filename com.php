...
<h3 style="background-color:green"> Complaint Form</h3>       
 <p> If your complaint is true we will definitely take an action </p> <br>
 <br> <br> 
<?php 
    if(isset($msg)){       
...
?> 
 <form class="form" action="com.php" method="post" >         
    ...
    <input size="55"  type="text" name="name1" placeholder="Enter your Complaint person profile name" required /> <br> <br>  
    <input size="55"  type="text" name="cod" placeholder="Enter what is your complaint" required /> <br> <br>  
