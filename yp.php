...
<body bgcolor="#F0F0F0">
<div align="middle" style="background-color:#3b5998;height:40px" ><a style="float:left" href="news.php"> <button type="button" style="width:100px;height:40px;background-color:#3b5998;border:1px solid #3b5998"> <font size="4"> News Feed </font></button> </a> <font color="black" size="6">VINTAX <sub>vc</sub> &nbsp;&nbsp;&nbsp;</font>
 </div>   
	<br>
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM post WHERE email = '".$id."' ORDER BY id ASC ");
	...
	<div align="middle" style="background-color:#464646"> <video loop width="420" height="320" controls> <source src="<?php echo $product_array[$key]["video"]; ?>"> </video> </div> <br> 
    <br>
	<div align="left"> <a href="likeyp.php?id=<?php echo $product_array[$key]["id"]; ?>"> <img src="p.png" style="width:40px;height:30px;border-radius:50%;padding:5px;vertical-align:middle;margin-right:15px;" /> </a> <a style="float:right" href="share.php?id=<?php echo $product_array[$key]["id"]; ?>"> <img src="s.png" style="width:40px;height:30px;border-radius:50%;padding:5px;vertical-align:middle;margin-right:15px;" />  </a> 
	</div>
	<br>
	<div> &nbsp;&nbsp;&nbsp;<?php echo $product_array[$key]["love"]; ?> &nbsp;&nbsp; views </div>
	<br>
